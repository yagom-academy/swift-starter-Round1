...
struct PeperoMarket {
    private let defaultPepero = Pepero(bodySize: 10,
                                       bodyShape: "***",
                                       topping: "",
                                       stickSize: 4)
    private let almondPepero = Pepero(bodySize: 12,
                                     ...
                                     topping: "&",
                                     stickSize: 4)
    private let peanutPepero = Pepero(bodySize: 12,
                                      bodyShape: "***",
                                      topping: "#",
                                      stickSize: 6)
    private let nudePepero = Pepero(bodySize: 6,
                                    bodyShape: "|0|",
                                    topping: "",
                                    stickSize: 4)
    ...
    func giveMenu() {
        peperoEmployee.drawOrderedMenu(bodyShape: defaultPepero.bodyShape,
        ...
        peperoEmployee.drawOrderedMenu(bodyShape: peanutPepero.bodyShape,
                                       ...
                                       stickSize: peanutPepero.stickSize)
        peperoEmployee.drawOrderedMenu(bodyShape: nudePepero.bodyShape,
                                       topping: nudePepero.topping,
                                       bodySize: nudePepero.bodySize,
                                       stickSize: nudePepero.stickSize)
    }
}
