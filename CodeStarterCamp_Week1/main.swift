...
//
//print("반환함수 시작")
//func iceBodyFunc(s: String) -> String {
//    for _ in 1...7 {
//        print("***********")
//    }
//    return s
...
// */
//func iceBarFunc(s: String) -> String {
//
//    for _ in 1...3 {
//        print("    | |    ")
//    }
...
result(바길이: 10, 몸통: " ***", 토핑: "", 몸통길이: 4)
result(바길이: 12, 몸통: "***", 토핑: "&", 몸통길이: 4)
result(바길이: 12, 몸통: "***", 토핑: "#", 몸통길이: 6)
result(바길이: 6, 몸통: " |0|", 토핑: "", 몸통길이: 4)
