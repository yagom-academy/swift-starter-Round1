...
func pepeHandleHeight(height: Int) {
    for _ in 1...height {
        print("| |")
    }
}

func pepeBody(bodyMaterial: String, bodyToping: String) {
    print("\(bodyMaterial)"+"\(bodyToping)")
}

func pepeBodyHeight(bodyHeight: Int) {
    for _ in 1...bodyHeight {
        print(pepeBody(bodyMaterial: <#T##String#>, bodyToping: <#T##String#>))
        
    }
}
pepeBody(bodyMaterial: "e", bodyToping: "fg")
